...
go build -o build/darwin/chainservice_$VER -ldflags="-X main.commit=${GIT_COMMIT}"
env GOOS=linux GOARCH=amd64 go build -o build/linux/chainservice_$VER -ldflags="-X main.commit=${GIT_COMMIT}"
